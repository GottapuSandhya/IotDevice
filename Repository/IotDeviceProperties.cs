...
namespace DotNetIot.Repository.IotDeviceProperties
{
    ...
    {
        private static string connectionString="HostName=Chinna.azure-devices.net;SharedAccessKeyName=iothubowner;SharedAccessKey=zDnyUcwooR/zXEp3xces29yNYDKSJUVJbtSKEzLN85Y=";
        public static RegistryManager registryManager=RegistryManager.CreateFromConnectionString(connectionString);
        public static DeviceClient client=null;
        public static string myDeviceConnection="HostName=Chinna.azure-devices.net;DeviceId=sandhya;SharedAccessKey=pKa3SsenYqSO9UE7nv09+UYYd9VV1vFNkHZ6Kod2LVY=";
